...
- **Формы, интеграции и расширения**: `parse_form`, `find_http_services`, `find_web_services`, `find_xdto_packages`, `find_exchange_plan_content`, `detect_extensions`, `get_overrides` / `find_ext_overrides` с `total` / `truncated`.
