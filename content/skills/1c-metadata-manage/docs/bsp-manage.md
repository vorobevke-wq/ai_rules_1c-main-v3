...
- **Installed `bsp-*` skills** — Find BSP registration patterns and expected API names; verify project-specific availability through `rlm-tools-bsl` `search_methods` / `find_exports` or equivalent project-source search.
