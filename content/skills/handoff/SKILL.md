...
- **MCP tools / skills**: especially relevant tools and skills (`search_metadata` `object_structure` for X, Metacode impact templates before refactoring Y, installed `bsp-*` skills for topic Z).
