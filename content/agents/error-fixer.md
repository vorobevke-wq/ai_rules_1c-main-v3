...
- **analyze_file** — check touched `.bsl` files for syntax and analyzer errors (limit: 1 per cycle by default, up to 3 only on substantive defects — see `AGENTS.md → MCP Tool Calling → B.1`)
