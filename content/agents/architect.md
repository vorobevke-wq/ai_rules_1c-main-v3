...
Key tools: **search_code**, **search_metadata**, **rlm-tools-bsl** (`search`, `search_objects`, `get_object_full_structure`, `find_references_to_object`, `find_call_hierarchy`), **templatesearch**
